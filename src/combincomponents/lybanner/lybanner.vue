...
export default {
  ...
  methods: {
    ...
    updateItems() {
      this.items = this.$children.filter(child => child.$options.name === 'LyBannerItem');
      console.log('==this.updateItems====', this.items)
    },
...
//    commit(types.handleCarouselData, {...params, data: resp.data})
//  })
  },
