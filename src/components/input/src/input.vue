      ...
      wrapClasses () {
        return [
          `${prefixCls}-wrapper`,
          {
            ...
            [`$[prefixCls]-group-${this.size}`]: (this.append || this.prepend || (this.search && this.enterButton)) && !!this.size,
...
<style lang="less" scoped="scoped">
  @import "../../../assets/less/components/input.less";
</style>